...
template <typename T>
constexpr TVector<2, T>::TVector(T x, T y): x(x)
                                          , y(y)
{
}

template <typename T>
constexpr TVector<2, T>::TVector(T scalar): x(scalar)
                                          , y(scalar)
{
}

template <typename T>
constexpr TVector<2, T>::TVector(const TVector<2, T>& other): x(other.x)
                                                            , y(other.y)
{
}
...
template <typename T>
constexpr TVector<3, T>::TVector(T x, T y, T z): x(x)
                                               , y(y)
                                               , z(z)
{
}
...
template <typename T>
constexpr TVector<3, T>::TVector(T scalar): x(scalar)
                                          , y(scalar)
                                          , z(scalar)
{
}
...
template <typename T>
constexpr TVector<3, T>::TVector(const TVector<3, T>& other): x(other.x)
                                                            , y(other.y)
                                                            , z(other.z)
{
}
...
template <typename T>
constexpr TVector<3, T>::TVector(const TVector<2, T>& other, T z): x(other.x)
                                                                 , y(other.y)
                                                                 , z(z)
{
}
...
template <typename T>
constexpr TVector<4, T>::TVector(T x, T y, T z, T w): x(x)
                                                    , y(y)
                                                    , z(z)
                                                    , w(w)
{
...
template <typename T>
constexpr TVector<4, T>::TVector(T scalar): x(scalar)
                                          , y(scalar)
                                          , z(scalar)
                                          , w(scalar)
{
...
template <typename T>
constexpr TVector<4, T>::TVector(const TVector<4, T>& other): x(other.x)
                                                            , y(other.y)
                                                            , z(other.z)
                                                            , w(other.w)
{
...
template <typename T>
constexpr TVector<4, T>::TVector(const TVector<3, T>& other, T w): x(other.x)
                                                                 , y(other.y)
                                                                 , z(other.z)
                                                                 , w(w)
{
...
template <typename T>
constexpr TVector<4, T>::TVector(const TVector<2, T>& other, T z, T w): x(other.x)
                                                                      , y(other.y)
                                                                      , z(z)
                                                                      , w(w)
{
...
template <typename T>
constexpr TVector<4, T>::TVector(const TVector<2, T>& other1, const TVector<2, T>& other2)
    : x(other1.x)
    , y(other1.y)
    , z(other2.x)
    , w(other2.y)
