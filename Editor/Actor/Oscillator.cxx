...
AOscillator::AOscillator()
{
    ...
    PhysicsComponent = Ref<RPhysicsComponent>::Create();
}
...
RObject* AOscillator::FindComponent(RTTI::FTypeId TypeId)
{
    if (PhysicsComponent->TypeId() == TypeId)
    {
        return PhysicsComponent.Raw();
    }

    return Super::FindComponent(TypeId);
}
