...
bool RVulkanGraphicsPipeline::Create()
{
    ...
    VkPipelineDepthStencilStateCreateInfo DepthStencilState{
        ...
        .pNext = nullptr,
        .depthTestEnable = Desc.AttachmentFormats.DepthFormat.has_value(),
        .depthWriteEnable = Desc.AttachmentFormats.DepthFormat.has_value(),
        .depthCompareOp = VK_COMPARE_OP_LESS,
        .depthBoundsTestEnable = VK_FALSE,
        .stencilTestEnable = Desc.AttachmentFormats.StencilFormat.has_value(),
        .front = {},
        .back = {},
        .minDepthBounds = 0.0f,
        .maxDepthBounds = 1.0f,
